...
هدف: سازنده قبل از اولین نصب واقعی روی VM مشتری، کل سناریوی «نصب» را روی ماشین
...
کلیدهای امضا (مثل روز نصب — فقط برای «امضا»؛ بوت‌ها عمداً بدون env = بوت سرد):
  SANATIFY_LIC_ED_PRIV — کلید خصوصی Ed25519 سازنده (الزامی؛ بدون آن خروج با راهنما)
